...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->command->info('   Admin    : admin@pinjaman.com / password');
        $this->command->info('   Karyawan : karyawan@pinjaman.com / password');
        ...
        // $totalBunga        = round($jumlahPinjaman * ($bunga30->persentase / 100));
