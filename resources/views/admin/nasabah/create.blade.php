...
<div class="py-4">
    ...
    <form method="POST" action="{{ route('admin.nasabah.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow p-6">
                    ...
                    <div class="mb-6 pb-4 border-b border-gray-100">
                        <h2 class="text-base font-semibold text-gray-800">Data Nasabah Baru</h2>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="alamat" rows="3" placeholder="Alamat lengkap nasabah"
                                  class="w-full border {{ $errors->has('alamat') ? 'border-red-400 bg-red-50' : 'border-gray-300' }} rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
