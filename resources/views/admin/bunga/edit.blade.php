...
@section('page-title', 'Edit Bunga Pinjaman')
    ...
    <div class="max-w-lg">
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <div class="mb-6 pb-4 border-b border-gray-100">
                <h2 class="text-base font-semibold text-gray-800">Edit Data Bunga</h2>
                <p class="text-sm text-gray-400 mt-0.5">Perubahan akan langsung tersimpan</p>
            </div>

            <form method="POST" action="{{ route('admin.bunga.update', $bunga) }}">
                @csrf @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_bunga" value="{{ old('nama_bunga', $bunga->nama_bunga) }}"
                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        <input type="number" name="persentase" value="{{ old('persentase', $bunga->persentase) }}"
                ...
                <div class="mb-4">
                    ...
                    <select name="jenis"
                        ...
                        <option value="flat"    {{ old('jenis', $bunga->jenis) == 'flat'    ? 'selected' : '' }}>Flat</option>
                        <option value="efektif" {{ old('jenis', $bunga->jenis) == 'efektif' ? 'selected' : '' }}>Efektif</option>
                    </select>
                    @error('jenis')
                        <p class="text-red-500 text-xs mt-1"><i class="fa fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <select name="is_active"
                        ...
                        <option value="1" {{ old('is_active', $bunga->is_active) == '1' ? 'selected' : '' }}>Aktif</option>
                        <option value="0" {{ old('is_active', $bunga->is_active) == '0' ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                </div>
